...
Инструмент для закрытия возражений - твой личный ИИ-помощник в переговорах с клиентами. Я обучен на сотнях тысяч реальных диалогов риэлторов со своими клиентами.

💬 Просто отправь текст с возражением, и я предложу несколько готовых вариантов ответа, чтобы:

✅ Мягко снять сомнения клиента
✅ Показать ценность твоих услуг
✅ Сохранить контакт и продвинуть сделку вперёд

⚡️ Быстро, профессионально и без лишних усилий - экономишь время и повышаешь конверсию продаж.

🎯 Отправь возражение прямо в этот чат, и я подготовлю 3–5 эффективных ответов, которые реально работают.
'''
...
GENERATING = "⏳ Генерирую сценария возражения ответа… это займет до минуты."
ERROR_TEXT = ('''
...
ai_tools_text = '''
📐 *Генератор красивых планировок* (*β-версия*) — 
создавай наглядные схемы квартир и домов.

🛋️ *Генератор дизайна интерьера* — 
быстрые визуализации стиля и меблировки.

🤖 *ИИ для закрытия возражений* —
готовые аргументы и ответы на частые сомнения клиентов.

✍️ *ИИ для написания отзывов от клиентов* —
