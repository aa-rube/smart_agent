...
# =============================================================================
MAIN_MENU_TITLE = ('''
Клиенты ленятся писать отзывы? Создай живой и убедительный отзыв о работе риэлтора всего за пару минут. Останется только опубликовать!
✅ 3 готовых варианта с нужным тоном и длиной
✅ Четкая структура: вводные → процесс → результат → ценность для клиента
✅ Возможность редактировать, сохранять и экспортировать в файл
🎯 Готовы? Нажмите «Создать отзыв»
'''
)
ASK_CLIENT_NAME = (
