...
HOME_TEXT = (
    ...
    "Загрузите *аудио* разговора или вставьте *текст переписки* — бот:\n"
    "• выделит *сильные стороны* и *ошибки* коммуникации,\n"
    "• составит *краткое резюме* встречи,\n"
    "• зафиксирует *договорённости и следующие шаги*.\n\n"
