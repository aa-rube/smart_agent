...
Описание должно быть поделено на 4 логических блока, каждый из которых плавно перетекает в следующий.
Объём — 900–1300 символов, без маркированных списков и пунктов.

1️⃣ О локации и доме

Начни с описания места, где находится объект:
 • город, район, улица, особенности окружения;
 • что делает локацию привлекательной (транспорт, зелёные зоны, школы, парки, магазины и т.д.);
 • если известен номер дома — можешь упомянуть близлежащие объекты, усиливающие ценность.
Тон — информативный, спокойный, с лёгкой эмоциональной окраской (без пафоса).

2️⃣ О квартире (или доме / помещении)

Расскажи о самом объекте:
 • планировка, состояние, освещённость, особенности (балкон, вид, кухня, ремонт, зонирование и т.п.);
 • акцентируй внимание на сильных сторонах, не выдумывая ничего лишнего;
 • избегай клише вроде “уютная”, “светлая”, “просторная”, если это не подтверждено характеристиками.
Фокус — чтобы человек почувствовал атмосферу жизни внутри.

3️⃣ О юридической частоте и документах

Покажи, что сделка безопасна и надёжна:
 • чистая история, один собственник, без обременений;
 • полная готовность к сделке, возможна ипотека или любая форма оплаты;
 • если типичный вариант — пиши “документы полностью готовы к продаже, без скрытых нюансов”.

Тон — уверенный и экспертный.
Эта часть должна вызывать доверие.

4️⃣ Финальный акцент (мягкая мотивация)

Заключи текст лёгким эмоциональным штрихом:
 • создавай образ жизни, который покупатель получит (тишина, семья, комфорт, динамика центра и т.д.);
 • не призывай “звонить” — просто подведи к мысли, что объект стоит внимания.

Например: “Такое жильё редко появляется в продаже — особенно в этом районе.”
Или: “Квартира, где можно просто заехать и начать новую главу жизни.”
...
Пиши честно, экспертно и с вниманием к деталям. Текст должен вызывать доверие и интерес, как будто его рассказывает опытный риэлтор своему клиенту.
